"""
Django settings for insight_global_tale_45852 project.
...
ROOT_URLCONF = 'insight_global_tale_45852.urls'
...
WSGI_APPLICATION = 'insight_global_tale_45852.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "insight_global_tale_45852 API",
    "DESCRIPTION": "API documentation for insight_global_tale_45852 App",
    "VERSION": "v1",
}
